    ...
    $.ajax({
        ...
        success: function (data) {
			if(data==0){
				Swal.fire({
	                icon: 'error',
	                title: 'El horario ya esta registrada',
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(js, function (a, b) {
                t.row.add([b.id, b.turno,b.dia,b.horaInicio,b.horaFinal, botonera]);
...
$(document).ready(function () {
    ...
    $(document).on('click', '.eliminar', function () {
        Swal.fire({
            ...
            text: "¿Esta seguro de querer eliminar este horario?",
            icon: 'warning',
